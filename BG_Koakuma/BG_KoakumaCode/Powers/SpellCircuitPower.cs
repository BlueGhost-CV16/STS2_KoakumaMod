...
[RegisterPower]
public sealed class SpellCircuitPower : KoakumaPower, ISecondaryResourceHookListener
{
    ...
    public async Task AfterSecondaryResourceSpent(SecondaryResourceSpendContext context)
    {
        ...
        {
            await CreatureCmd.GainBlock(Owner, new BlockVar(Amount * context.Amount, ValueProp.Unpowered), null);
        }
    }
}
