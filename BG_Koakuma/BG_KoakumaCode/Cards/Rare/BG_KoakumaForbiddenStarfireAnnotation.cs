...
public sealed class BG_KoakumaForbiddenStarfireAnnotation : KoakumaRareCard
{
    ...
    protected override IEnumerable<DynamicVar> CanonicalVars => [new PowerVar<ForbiddenImmortalMagicFlamePower>("Power", 1)];

    protected override async Task OnPlay(PlayerChoiceContext choiceContext, CardPlay cardPlay)
    {
        await PowerCmd.Apply<ForbiddenImmortalMagicFlamePower>(choiceContext, Owner.Creature, Amount("Power"), Owner.Creature, this);
    }
